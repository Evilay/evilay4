...
<body class="homepage is-preload">
    <div id="page-wrapper">
        ...
        <div id="header">
            ...
            <div class="inner">
                <header>
                    <h1><a href="index.html" id="logo">Голосование</a></h1>
                    <hr />
        ...
        <div>
            ...
            <div style="display: flex;align-items: center;justify-content: center; width: 100%; margin-bottom: 2em; ">
                <div style="display: flex; border-radius: 20px; box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22);justify-content: center; width: 38%;padding: 3.5%">
                    <form style="padding-right: 10%; border-right: 1px solid #707070">
                        ...
                        Введите имя
                        <input style="border-radius:10px; margin-bottom: 20px" type="text" name="log" id="name" value="">
            ...
            <div style="width: 100%; height: 100%; text-align: center; background-color: #df7366;">
                <div style="padding: 2em; padding-left: 20%; padding-right: 20%; vertical-align: top; height: 100%;  height: 29em; ">
                    <div style="background-color: #f0f4f4; vertical-align: center ; box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22); border-radius: 20px;">
                        <div style="display:inline-block; padding: 1em; vertical-align: top;">
                            <header>
                ...
                <div style="padding: 2em; padding-left: 20%; padding-right: 20%; vertical-align: top; height: 100%;  height: 29em; ">
                    <div style="background-color: #f0f4f4; vertical-align: center ; box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22); border-radius: 20px;">
                            ...
                            <div style="display:inline-block; padding: 1em; height: 100%; vertical-align: top;">
                                <header>
                                    <h3><a href="#" style="color: #483949">Президент Украины</a></h3>
                                </header>
                                <p style="color: #483949">1 место:</p>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="copyright">
                                        ...
                                        Коммерческое использование материалов сайта GOLOSOVANIE.RU запрещено. В остальных случаях обязательно наличие индексируемой ссылки со словом "Источник" на сайт или на страницу, содержащую этот материал.
                                    </div>
                                   ...
                                   <!--  <script type= "text/javascript">
                                    ...
                                    function drawChart() {
                                        var data = google.visualization.arrayToDataTable([
                                            ['Год', 'Владимер Путин', 'США', 'Украина'],
                                            ['Путин', 500, 70, 90],
                                        ]);
                                        var options = {
                                            title: 'Добыча нефти',
