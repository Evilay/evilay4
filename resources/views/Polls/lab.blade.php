...
<div class="container">
    ...
    <div class='row @if(count($pollValue)!= 0) show @else hidden @endif' id='articles-wrap'>
        ...
        <table class="table table-striped ">
            ...
            @foreach($pollValue as $poll)

                <tr>

                    <td>{{ $poll->id }}</td>

{{--                    <td><a href="{{ route('article.show', ['id' => $poll->getId()]) }}">{{ $poll->getName() }}</a></td>--}}

{{--                    <td><a href="" class="delete" data-href=" {{ route('article.destroy',$poll->id) }} ">Удалить</a></td>--}}
    ...
    <div class="row">
        ...
        <div class="alert alert-warning @if(count($pollValue) != 0) hidden @else show @endif" role="alert"> Записей нет</div>
